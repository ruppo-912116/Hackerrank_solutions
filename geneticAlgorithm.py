...
def selection(agents):
    # lambda function is an anonymous function that takes agent and returns fitness value of agents
    # sorted sorts the agents according to agent.fitness using the function
    # sorted is ascending so reverse = true for descending order
